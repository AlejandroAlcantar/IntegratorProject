...
logger = logger.CreateLogger(file_name='predict.log')
...
class ModelAPIPredictor:
    ...
    def __init__(self, model_path):
        ...
        """
        logger.info("Predictor was instantiated.")
    ...
    def predict(self, new_data):
        ...
        """
        logger.info("predicts was requested")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        'new_data',
        type=str,
        help='Path to the file containing new data for prediction')
